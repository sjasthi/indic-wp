    ...
    function getAPIList($apiChoice)
    {
        ...
        if ($apiChoice == "getFillerCharacters") {
            ...
            foreach ($singleInputAPIs as $api) {
                $output = $output . '<tr class="table-data"><th scope="row" class="methodCell" id="' . $api . 'Method">' . $api . '</th><td class="inputCell"  id="' . $api . 'Input"><input type="text" size="12" class="inputText" id="' . $api . 'InputText"></td><td class="input2Cell" id="' . $api . 'Input2">N/A</td><td class="input3Cell" id="' . $api . 'Input3">N/A</td><td class="expectedCell" id="' . $api . 'Expected"></td><td = class="actualCell" id="' . $api . 'Actual"></td><td class="passFail" id="' . $api . 'PassFail"></td><td class="jsonCell" id="' . $api . 'JSON"></td></tr>';
            }
            foreach ($doubleInputAPIs as $api) {
                $output = $output . '<tr class="table-data"><th scope="row" class="methodCell" id="' . $api . 'Method">' . $api . '</th><td class="inputCell"  id="' . $api . 'Input"><input type="text" size="12" class="inputText" id="' . $api . 'InputText"></td><td class="input2Cell"  id="' . $api . 'Input2"><input type="text" size="12" id="' . $api . 'InputText2"></td><td class="input3Cell" id="' . $api . 'Input3">N/A</td><td class="expectedCell" id="' . $api . 'Expected"></td><td = class="actualCell" id="' . $api . 'Actual"></td><td class="passFail" id="' . $api . 'PassFail"></td><td class="jsonCell" id="' . $api . 'JSON"></td></tr>';
            }
            foreach ($tripleInputAPIs as $api) {
                $output = $output . '<tr class="table-data"><th scope="row" class="methodCell" id="' . $api . 'Method">' . $api . '</th><td class="inputCell"  id="' . $api . 'Input"><input type="text" size="12" class="inputText" id="' . $api . 'InputText"></td><td class="input2Cell"  id="' . $api . 'Input2"><input type="text" size="12" id="' . $api . 'InputText2"></td><td class="input3Cell"  id="' . $api . 'Input3"><input type="text" size="12" id="' . $api . 'InputText3"></td><td class="expectedCell" id="' . $api . 'Expected"></td><td = class="actualCell" id="' . $api . 'Actual"></td><td class="passFail" id="' . $api . 'PassFail"></td><td class="jsonCell" id="' . $api . 'JSON"></td></tr>';
            }
        }
